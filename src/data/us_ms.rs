...
const COUNTY_NAME: &str = "United States (Mississippi)";
const COUNTY_CODE: Country = Country::US_MS;

/// Generate holiday map for United States (Mississippi).
#[allow(
    unused_mut,
    unused_variables,
...
pub fn build(years: Option<&std::ops::Range<Year>>) -> Result<HolidayPerYearMap> {
    ...
    build_year(
        ...
        2002,
        [(
            NaiveDate::from_ymd_res(2002, 4, 29)?,
            "Confederate Memorial Day",
        )],
        &mut map,
        COUNTY_CODE,
