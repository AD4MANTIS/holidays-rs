...
const COUNTY_NAME: &str = "United States (United States Minor Outlying Islands)";
const COUNTY_CODE: Country = Country::US_UM;

/// Generate holiday map for United States (United States Minor Outlying Islands).
#[allow(
    unused_mut,
    unused_variables,
